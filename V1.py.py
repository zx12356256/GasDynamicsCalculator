...
class MainWindow:
    def __init__(self, master):
        ...
        btn5 = tk.Button(master, text="5. 速度参数激波计算", command=self.open_velocityshockwave, **button_style)
        ...
        self.canvas.create_window(center_x + btn_width -40, center_y + btn_height + 280, window=btn5)
    ...
    def open_flow(self):
        pass
    def open_velocityshockwave(self):
